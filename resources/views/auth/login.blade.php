...
<div class="d-flex flex-fill overflow-hidden">
    ...
    <div class="col align-middle">
        <div class="row justify-content-center p-3">
            <form id="login" method="POST" action="{{ route('login') }}" class="col-4 rounded p-3">
                {{ csrf_field() }}
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="password" class="form-label d-flex justify-content-between mt-4">
                            Password
                            <a class="btn btn-link text-decoration-none fw-lighter p-0" href="{{ route('recover') }}">Forgot your password?</a>
                        </label>
